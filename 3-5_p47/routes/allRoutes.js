...
// ----------------------------------      GET /articles/all     ----------------------------------
router.get("/articles/all", userAuth, (req, res) => {
  res.status(200).json(BDD.articles);
});
// ----------------------------------      GET /cart/all     ----------------------------------
router.get("/cart/all", userAuth, (req, res) => {
...
router.delete("/articles/:articleId", adminAuth, (req, res) => {
...
router.post("/articles", adminAuth, (req, res) => {
  ...
  if (
    ...
    if (typeof newArticle.label !== "string") {
      res.status(405).send("Type incorrect");
    }
...
router.patch("/cart/:articleId", userAuth, (req, res) => {
...
router.delete("/cart/:articleId", userAuth, (req, res) => {
  const { articleId } = req.params;
...
// ----------------------------------      POST /cart/pay      ----------------------------------
router.post("/cart/pay", userAuth, (req, res) => {
